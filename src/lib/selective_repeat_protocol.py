...
class SelectiveRepeatSender:
    def __init__(self, socket, address, window_size, timeout=1,packet_loss_rate=0.0):
        self.socket = socket
    ...
    def send_segment (self,seq_num,file_iterator)
    ...
    def timer_thread(self, file_iterator):
        while True:
            ...
            for seq_num in self.timer.keys:
                self.send_segment (self,seq_num,file_iterator)
